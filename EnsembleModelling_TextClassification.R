...
Mydata_finalPred$Prediction <- Mydata_finalPred$CONSENSUS_CODE
...
write.csv(Mydata_finalPred, "Total_Predicted_Summary.csv")
write.csv(Final_Submission, "Final_Submission_Summary.csv")
write.csv(Output_Just_Class_Predictions, "Output_Predictions.csv")
